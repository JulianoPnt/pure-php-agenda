    ...
    <div class="container justify-content-center my-5">
        ...
        <div class='col-12 size-form mt-5'>
            <form>
                ...
                <h4>Phones info</h4>
                <div class="form-group" v-for="(phone, index) in contact.phones" v-bind:key="index">
                    <label>Number</label>
                    <div class="row">
                        <div class="col-8">
                        ...
                        <div class="col-4">
                            <button v-if="index === Object.keys(contact.phones).length - 1" type="button" class="btn btn-success" @click="addPhone()">Add</button>
...
export default {
    ...
    methods: {
        ...
        removePhone(index) {
            if(Object.keys(this.contact.phones).length === 1)
                return false;
